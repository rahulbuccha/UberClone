...
class PackageViewController: UIViewController {
    ...
    @IBAction func showHome(_ sender: UIStoryboardSegue) {
    }
        ...
        override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
            if segue.identifier == "showHome" {
                ...
                dest.hero.modalAnimationType = .selectBy(presenting: .zoomSlide(direction: .down), dismissing: .zoomSlide(direction: .down))
